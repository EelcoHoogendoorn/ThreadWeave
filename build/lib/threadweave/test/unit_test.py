"""
some unit tests that demonstrate some core functionality

use context as python context?
ensures cleanup

also use context for declaration?


BUG; how to hash stencil? just hash on mem location?
"""
